...
public:
    static QString countryCodeFromISO3166 (QLocale::Country countryEnum) {
        return countryCodes [countryEnum];
    }
    static QString countryNameFromISO3166 (QLocale::Country countryEnum) {
        return QLocale::countryToString (countryEnum);
    }
    static QString languageCodeFromISO639 (QLocale::Language languageEnum) {
        return languageCodes [languageEnum];
    }
    static QString languageNameFromISO639 (QLocale::Language languageEnum) {
        return QLocale::languageToString (languageEnum);
    }
};
